...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    SCULKIFIED_NETHERITE("sculkified_netherite", 37, new int[]{3, 7, 9, 3}, 15,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0f, 0.1f, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),

    WARDEN("warden", 38, new int[]{5, 8, 10, 5}, 15,
            SoundEvents.ENTITY_WARDEN_SONIC_BOOM, 3.0f, 0.1f, () -> Ingredient.ofItems(ModItems.WARDEN_HEART));
