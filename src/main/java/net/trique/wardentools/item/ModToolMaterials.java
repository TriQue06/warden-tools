...
public enum ModToolMaterials implements ToolMaterial {
    ...
    SCULKIFIED_NETHERITE(MiningLevels.NETHERITE, 2031, 10.0f, 4.5f, 15, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),
    WARDEN(MiningLevels.NETHERITE, 2468, 11.5f, 6.0f, 15, () -> Ingredient.ofItems(ModItems.WARDEN_HEART));
